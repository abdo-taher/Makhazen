                        ...
                        <div class="customer-details-new-card">
                            ...
                            <div class="customer-details-new-card-content">
                                ...
                                <ul class="customer-details-new-card-content-list">
                                    ...
                                    <li>
                                        <form id="customer-slice" class="w-100" action="{{ route('admin.customer.updateSlice',$customer['id']) }}" method="post" >
                                            <select class="js-example-responsive form-control slice_id" name="slice_id" data-success="{{translate('update_customer_slice')}}">
                                                @foreach($customerSlices as $customerSlice)
                                                    <option value="{{ $customerSlice['id'] }}" {{ $customer['banner_type'] == $customerSlice->id ? 'selected':''}}>{{ $customerSlice['name'] }}</option>
                                                @endforeach
                                            </select>
                                        </form>
                                    </li>
...
@push('script')
    <script src="{{dynamicAsset(path: 'public/assets/back-end/js/admin/customer/customer-view.js')}}"></script>
