...
use App\Http\Controllers\Admin\Settings\CustomerSlicesController;
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {
    ...
    Route::group(['prefix' => 'customer', 'as' => 'customer.','middleware'=>['module:user_section']], function () {
        Route::controller(CustomerController::class)->group(function (){
            ...
            Route::post(Customer::SLICE[URI],'updateSlice')->name('updateSlice');
        });
    ...
    Route::group(['prefix' => 'customer-slice', 'as' => 'customer-slice.'], function () {
        Route::controller(CustomerSlicesController::class)->group(function (){
            Route::get(CustomerSlice::VIEW[URI], 'index')->name('customer-slice');
            Route::get(CustomerSlice::LIST[URI], 'getList')->name('fetch');
            Route::post(CustomerSlice::ADD[URI], 'add')->name('customer-slice-store');
            Route::post(CustomerSlice::GET_UPDATE[URI], 'getUpdate')->name('customer-slice-edit');
            Route::post(CustomerSlice::UPDATE[URI], 'update')->name('customer-slice-update');
            Route::post(CustomerSlice::DELETE[URI], 'delete')->name('customer-slice-delete');
            Route::post(CustomerSlice::STATUS[URI], 'updateStatus')->name('customer-slice-status-update');
        });
    });
