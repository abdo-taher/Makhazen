...
use App\Models\User;
use App\Repositories\CustomerSliceRepository;
...
class CustomerController extends BaseController
{
    ...
    public function __construct(
        ...
        private readonly CustomerSliceRepository        $customerSliceRepo,
    ...
    public function getView(Request $request, $id): View|RedirectResponse
    {
        ...
        $customerSlices = $this->customerSliceRepo->getList();
        if (isset($customer)) {
            ...
            return view(Customer::VIEW[VIEW],compact('customer','orders','orderStatusArray','customerSlices'));
        }
    ...
    public function updateSlice(Request $request,$id)
    {
        $customer = User::where('id',$id);
        if($customer){
            $customer->update(['slice_id'=>$request['slice_id']]);
        }else{
            Toastr::error(translate('customer_Not_Found'));
            return back();
        }
